...
RBD = A*ddq + C*dq + Q;
params = [m_1 MX_1 MY_1 MZ_1 XX_1 XY_1 XZ_1 YY_1 YZ_1 ZZ_1 N_1 J_m1,...
          m_2 MX_2 MY_2 MZ_2 XX_2 XY_2 XZ_2 YY_2 YZ_2 ZZ_2 N_2 J_m2,...
          m_3 MX_3 MY_3 MZ_3 XX_3 XY_3 XZ_3 YY_3 YZ_3 ZZ_3 N_3 J_m3,...
          m_4 MX_4 MY_4 MZ_4 XX_4 XY_4 XZ_4 YY_4 YZ_4 ZZ_4 N_4 J_m4,...
          m_5 MX_5 MY_5 MZ_5 XX_5 XY_5 XZ_5 YY_5 YZ_5 ZZ_5 N_5 J_m5,...
          m_6 MX_6 MY_6 MZ_6 XX_6 XY_6 XZ_6 YY_6 YZ_6 ZZ_6 N_6 J_m6,...
          m_7 MX_7 MY_7 MZ_7 XX_7 XY_7 XZ_7 YY_7 YZ_7 ZZ_7 N_7 J_m7]';
fid = fopen('PHI.m', 'w');
fprintf(fid, '%% Auto-generated by dynamicModel.m on %s. Do not edit!\n', dateStr);
fprintf(fid, '%% If dynamicModel.m was modified after %s, generate this code again using:\n', dateStr);
fprintf(fid, '%% >> dynamicModel;\n\n');
